...
$connection = New-Object System.Data.SqlClient.SqlConnection ("Data Source=localhost;Initial Catalog=VIS_GD_STAGING;Integrated Security=SSPI")
$connection.Open()
...
echo "SQL Diagram successfully scripted and copied to the clipboard"
