...
public class SandboxDbContext : DbContext
{
	...
	protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
		optionsBuilder.UseSqlServer("Server=.;Database=VIS_GD_STAGING;User Id=CLSDataPortal;Password=CLSDataPortal01;Integrated Security=false;MultipleActiveResultSets=true;TrustServerCertificate=true");
